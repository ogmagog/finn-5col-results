...
.slider--thumbEnabled:hover {
  background-color: var(--w-s-color-background-primary-hover);
  border-color: var(--w-s-color-border-primary-hover);
  box-shadow: var(--w-shadow-slider-handle-hover);
}
.slider--thumbEnabled:focus {
  background-color: var(--w-s-color-background-primary-hover);
  border-color: var(--w-s-color-border-primary-hover);
  box-shadow: var(--w-shadow-slider-handle-hover);
}
.slider--thumbEnabled:active {
...
.animate-spinner {
  ...
  border-radius: 50%;
  border: calc(var(--spinner-size) / 8) solid rgba(var(--w-s-rgb-border-primary-subtle), 0.5);
  border-top-color: var(--w-s-color-border-primary);
  position: relative;
  animation: animate-spinner 0.75s infinite linear;
}
...
.hover\:s-bg-subtle-hover:hover {
  background-color: var(--w-s-color-background-subtle-hover);
}
.active\:s-bg-subtle-active:active {
  background-color: var(--w-s-color-background-subtle-active);
}
.h-48 {
  height: 4.8rem;
}
...
.bg-\[--w-aqua-200\] {
  background-color: var(--w-aqua-200);
}
.bg-\[--w-aqua-50\] {
  background-color: var(--w-aqua-50);
}
.bg-\[--w-green-100\] {
...
.bg-\[--w-yellow-100\] {
  background-color: var(--w-yellow-100);
}
.overscroll-x-none {
  overscroll-behavior-x: none;
}
.border-\[--w-aqua-200\] {
  border-color: var(--w-aqua-200);
}
.border-\[--w-aqua-50\] {
  border-color: var(--w-aqua-50);
}
.border-\[--w-green-100\] {
  border-color: var(--w-green-100);
}
.border-\[--w-red-100\] {
  border-color: var(--w-red-100);
}
.border-\[--w-yellow-100\] {
  border-color: var(--w-yellow-100);
}
.rounded-b-8 {
  border-bottom-left-radius: 8px;
...
.s-bg-primary-subtle-hover {
  background-color: var(--w-s-color-background-primary-subtle-hover);
}
.hover\:s-bg-info-subtle:hover {
  background-color: var(--w-s-color-background-info-subtle);
}
.hover\:s-bg-subtle:hover {
  background-color: var(--w-s-color-background-subtle);
}
.focus\:s-bg-info-subtle:focus {
  background-color: var(--w-s-color-background-info-subtle);
}
.s-text-positive {
  color: var(--w-s-color-text-positive);
}
.s-text\! {
...
.space-x-12 > :not([hidden]) ~ :not([hidden]) {
  --w-space-x-reverse: 0;
  margin-left: calc(1.2rem * calc(1 - var(--w-space-x-reverse)));
  margin-right: calc(1.2rem * var(--w-space-x-reverse));
}
.space-x-16 > :not([hidden]) ~ :not([hidden]) {
  --w-space-x-reverse: 0;
  margin-left: calc(1.6rem * calc(1 - var(--w-space-x-reverse)));
  margin-right: calc(1.6rem * var(--w-space-x-reverse));
}
...
.space-y-2 > :not([hidden]) ~ :not([hidden]) {
  --w-space-y-reverse: 0;
  margin-top: calc(0.2rem * calc(1 - var(--w-space-y-reverse)));
  margin-bottom: calc(0.2rem * var(--w-space-y-reverse));
}
.m-16 {
  margin: 1.6rem;
}
...
.sf-primary-tag-legendary {
  left: 10px;
  position: absolute;
  top: 10px;
}
@supports selector(:has(a, b)) {
  .sf-search-ad:has(.sf-search-ad-link:focus-visible) > .sf-search-ad-outline {
    border-color: var(--w-s-color-border-selected);
  }
  .sf-search-ad-legendary:has(.sf-search-ad-link:focus-visible) > .sf-search-ad-outline {
    border-color: var(--w-s-color-border-info-subtle);
  }
  .sf-search-ad-link:focus {
    -webkit-text-decoration: none;
    text-decoration: none;
  }
  .sf-search-ad-link:focus-visible {
    outline: none;
  }
  .sf-search-ad {
...
.sf-search-ad-legendary {
  border-radius: 12px;
}
.sf-search-ad-legendary:focus-within {
  background-color: var(--w-s-color-background-info-subtle);
}
.sf-search-ad-legendary:focus-within > .sf-search-ad-outline {
  border-color: var(--w-s-color-border-info-subtle);
  border-radius: 12px;
}
.sf-realestate-heading {
  display: -webkit-box;
  overflow: hidden;
  -webkit-box-orient: vertical;
  -webkit-line-clamp: 2;
...
@media (min-width: 480px) {
  ...
  .sf-realestate-location {
    max-width: 300px;
  }
  .sf-realestate-image-aspect-none {
...
.sf-carousel-smooth-scroll {
  scroll-behavior: smooth;
}
.sf-carousel-no-scrollbar {
  scrollbar-width: none;
  -ms-overflow-style: none;
}
.sf-carousel-no-scrollbar::-webkit-scrollbar {
  display: none;
}
.sf-carousel-indicator {
  background: linear-gradient(0deg, rgba(0, 0, 0, 0.582), rgba(0, 0, 0, 0.198) 67%, rgba(0, 0, 0, 0.055) 86%, transparent);
}
.sf-carousel-dot {
  border-radius: 8px;
  transition: 0.2s ease-in-out;
}
.sf-carousel-dot:not(.sf-carousel-dot-active) {
  background-color: #ffffffb3;
  height: 6px;
  width: 6px;
}
.sf-carousel-dot.sf-carousel-dot-active {
...
[data-rsbs-header] {
  ...
  box-shadow: 0 1px rgba(46, 59, 66, calc(var(--rsbs-content-opacity, 1) * 0.125));
  z-index: 1;
...
@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 2dppx) {
  [data-rsbs-header]:before {
    transform: translate(-50%) scaleY(0.75);
  }
}
...
[data-rsbs-footer] {
  ...
  box-shadow: 0 -1px rgba(46, 59, 66, calc(var(--rsbs-content-opacity, 1) * 0.125)), 0 2px 0 var(--rsbs-bg, #fff);
  overflow: hidden;
  z-index: 1;
...
.mapboxgl-ctrl-group.mapboxgl-ctrl .mapbox-gl-draw_ctrl-draw-btn {
  ...
  margin-bottom: 8px;
  box-shadow: 0 1px 6px #0000001f, 0 1px 1px #00000029;
  pointer-events: auto;
  cursor: pointer;
}
.map-overlay {
...
advt-component.banner-ad[placementid*="advt_middle"] {
  margin: 2rem 0;
  display: none;
}
</style>`;

bodyElement.innerHTML += cssInject;
